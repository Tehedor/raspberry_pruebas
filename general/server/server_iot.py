...
class IoTServer:
    ...
    def __init__(self, host='0.0.0.0', port=5000, street_light=None, toll=None, crane=None, weather_station=None, railroad_switch=None, radar=None, train=None):
...
# Servmotor
        ...
        def servmotor_actuator():
            try:
                ...
                # return jsonify(result), 201
                self.railroad_switch.control_servmotor_server(data.get("stateMotor"))
                return jsonify({"status": "success", "data": data}), 201
            except Exception as e:
